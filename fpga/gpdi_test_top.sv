...
// The TMDS encoder used to live here. It now lives in fpga/tmds_encoder.sv,
// because rung 3 (fpga/dvi_tx.sv) needs the same one and two copies of a
// DC-balance state machine is a bug waiting for someone to fix only one of
// them. This bitstream is unchanged in behaviour; it just needs that file on
// the yosys command line — see fpga/README.md.
